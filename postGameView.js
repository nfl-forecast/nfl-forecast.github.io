angular.module('nflforecast').component('postGameView', {
  controller: ["logoService", "teamService", PGVController],
  bindings: {
    game: "<"
  },
  templateUrl: "htmlTemplates/postGameView.html"

});

function PGVController(logoService, teamService)
{
