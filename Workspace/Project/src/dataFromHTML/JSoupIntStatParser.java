...
public class JSoupIntStatParser {
	public static ArrayList<String>[] get(String season) throws IOException {
		...
		usingStats.add("INT");
		usingStats.add("INT Yds");
		Document htmlFile = Jsoup.connect("https://www.nfl.com/stats/team-stats/defense/interceptions/" + season+ "/reg/all").get();
