...
public class FullStats{
	...
	public void combine()
	{
		...
		AllStats = temp;
		Stat[] temp2 = {PassPct, PassYardsPerAtt, PassTD, PassTDPct, PassIntPct, PassSacks, PassSackY, QBRating, RushAttempts, RushAverage, RushTD, RecAverage, RecTD, TackleTotal, Sacks, Interceptions, IntAverage, PassesDefended, Stuffs, StuffYds, FumLost, FumForced, FumOwnRec, FumOppRec, FumRecYds, FumTotalRec, KrAvg, PrAvg, FgPct, XpPct, KoAvg, KoRetAvgYds, PuntNetAvg, PuntIn20Pct, PuntRetAvg, FirstDownsTotal, FirstDownsPass, FirstDownsRush, ThirdDownsPct, Penalties, PenaltyYds, OffenseAvgYds, TotalTD, PointsFor, PointsAgainst, PointDifferential}; //tackles for loss
